...
for k in range(len(day_list)-1):
    ...
    #plot
    if pyspedas.time_double(start_time_list_list[0][0]) < pyspedas.time_double(start_time_list_list[1][0]):
        start_time_list = start_time_list_list[0]
        end_time_list = end_time_list_list[1]
    elif pyspedas.time_double(start_time_list_list[0][0]) > pyspedas.time_double(start_time_list_list[1][0]):
        start_time_list = start_time_list_list[1]
        end_time_list = end_time_list_list[0]
